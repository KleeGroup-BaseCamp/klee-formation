...
<kasper:page style="tuto" controllerclass="com.kleegroup.formation.ui.controller.tutorial.TutoController" title="Tutoriel - AverageField">
<table width="100%">
...
<kasper:form>
   <kasper:error/>
    <KleeFormation:average dtcid="DTC_TUTO_OBJECT" name="PRIX"/><br/>
   	<KleeFormation:average dtcid="DTC_TUTO_OBJECT" name="POIDS"/><br/>
 ...
 <h3>Code :</h3>
   <textarea readonly=true rows=3>
	&lt;KleeFormation:average dtcid="DTC_TUTO_OBJECT" name="PRIX"/&gt;
   	&lt;KleeFormation:average dtcid="DTC_TUTO_OBJECT" name="POIDS"/&gt;
   </textarea>
</div>
