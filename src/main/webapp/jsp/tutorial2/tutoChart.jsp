<%@page import="kasper.ui.controller.*,com.kleegroup.formation.controller.*,com.kleegroup.formation.ui.tutorial.*, java.util.*"%>
<%@taglib uri="/WEB-INF/kasper_KleeFormation.tld" prefix="KleeFormation" %>
<%@taglib uri="/META-INF/kasper.tld" prefix="kasper" %>

<kasper:page style="tuto" title="Tutoriel - Chart" controllerclass="com.kleegroup.formation.ui.controller.tutorial.TutoChartController">
<table width="100%">
