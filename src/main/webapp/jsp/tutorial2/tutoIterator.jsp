<%@page import="kasper.ui.controller.*,com.kleegroup.formation.ui.controller.*mcom.kleegroup.formation.uistruts.ui.controller.tutorial2.*.com.kleegroup.formation.uistruts.services.produit.*"/WEB-INF/kasper_KleeFormation.tld" prefix="KleeFormation" %>
<%@taglib uri="/META-INF/kasper.tld" prefix="kasper" %>

<kasper:page style="tuto" controllerclass="com.kleegroup.formation.ui.controller.tutorial.TutoMatrixtableController" title="Tutoriel - TableLayout">
<table width="100%">
