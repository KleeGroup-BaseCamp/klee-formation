<%@page import="kasper.ui.controller.*,com.kleegroup.formation.controller.*,com.kleegroup.formation.ui.tutorial.*,com.kleegroup.formation.services.produit.*,   java.util.*"%>
<%@taglib uri="/WEB-INF/kasper_KleeFormation.tld" prefix="KleeFormation" %>
<%@taglib uri="/META-INF/kasper.tld" prefix="kasper" %>
<kasper:page style="tuto" controllerclass="com.kleegroup.formation.ui.controller.tutorial.TutoSelectionController" title="Tutoriel - AutoComplete">
<table width="100%">
