<%@page import="kasper.ui.controller.*,com.kleegroup.formation.ui.controller.*,com.kleegroup.formation.ui.controller.tutorial2.*,  java.util.*"%>
<%@taglib uri="/WEB-INF/kasper_KleeFormation.tld" prefix="KleeFormation" %>
<%@taglib uri="/META-INF/kasper.tld" prefix="kasper" %>
<kasper:page style="tuto" controllerclass="com.kleegroup.formation.ui.controller.tutorial.TutoMatrixtableController" title="Tutoriel - MatrixTable">
<table width="100%">
...
<kasper:form>
   ...
   <KleeFormation:matrixtable dtcid="DTC_TUTO_OBJECT" name="SI_STOCK" columnfieldname="ETA_ID" rowfieldname="TYP_ID" readonly="<%=!controller.isModeEdit()%>"/><br/>
