...
<s:form>
	...
	<div class="row">
		...
		<div class="span3">
			...
			<s:textfield name="%{util.contextKey(#attr.item)}.debut" theme="xhtml_read"/>		
			</display:column>
			<display:column title="Fin" sortable="true">
			<s:textfield name="%{util.contextKey(#attr.item)}.fin"  theme="xhtml_read"/>		
			</display:column>
			<display:column title="Début" sortable="true">
			<s:textfield name="%{util.contextKey(#attr.item)}.debutAprem"  theme="xhtml_read"/>		
			</display:column>
			<display:column title="Fin" sortable="true">
			<s:textfield name="%{util.contextKey(#attr.item)}.finAprem"  theme="xhtml_read"/>		
			</display:column>
			</display:table>
			</br>
			</br>
