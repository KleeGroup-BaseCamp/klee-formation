<%@page contentType="text/html;charset=ISO-8859-1" import="java.util.List,com.kleegroup.formation.ui.controller.*,fr.klee.knock.core.*,fr.klee.knock.commun.*"%>

<%@taglib uri="/META-INF/kasper.tld" prefix="kasper"%>
<%@taglib uri="/WEB-INF/kasper_KleeFormation.tld" prefix="kasper_KleeFormation"%>

<kasper:page controllerclass="com.kleegroup.formation.ui.controller.referentiel.ReferentielListController" title="::KasperKleeFormation - Referentiel Liste">
